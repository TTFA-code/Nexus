...
export const CircuitBoardBackground = () => {
    return (
        ...
        >
            ...
            <div className="absolute top-[40%] left-0 h-[2px] w-48 animate-beam-h-slow opacity-0" style={{ animationDelay: '2s' }}>
                <div className="w-full h-full bg-gradient-to-r from-transparent via-[#bc13fe] to-white blur-[1px]"></div>
            </div>

            <div className="absolute top-[80%] left-0 h-[2px] w-64 animate-beam-h-slow opacity-0" style={{ animationDuration: '12s', animationDelay: '5s' }}>
            ...
            <div className="absolute left-[70%] top-0 w-[2px] h-56 animate-beam-v-slow opacity-0" style={{ animationDelay: '3s' }}>
                <div className="w-full h-full bg-gradient-to-b from-transparent via-[#bc13fe] to-white blur-[1px]"></div>
            </div>

            <div className="absolute left-[60%] top-0 w-[2px] h-24 animate-beam-v-fast opacity-0" style={{ animationDuration: '4s', animationDelay: '1s' }}>
